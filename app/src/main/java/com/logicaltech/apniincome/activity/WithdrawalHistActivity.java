...
public class WithdrawalHistActivity extends AppCompatActivity
{
    ...
    public void withdrawHistoryList(final String memberId)
    {
        ...
        String url = Constant.URL+"getWithdrawalHist?membercode="+memberId;
            ...
            public void onResponse(JSONArray response)
            {
                try
                {
                    ...
                    for (int i = 0; i < response.length(); i++)
                    {
                        ...
                        String INR_Amt = jsonObject2.getString("INR_Amt");
                        String tds = jsonObject2.getString("deductamt");
