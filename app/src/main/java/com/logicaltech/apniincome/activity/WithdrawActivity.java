...
public class WithdrawActivity extends AppCompatActivity
{
    ...
    String member_id,user_email,user_name,mobile_no=null,token="0",account_no,kyc_status="N",otp="0",weekDay,srno;
    ...
    Button Btn_withDraw,BtnHistory;
    Dialog dialog;
    @Override
    ...
    public void init()
    {
        ...
        BtnHistory = (Button) findViewById(R.id.button_withdrawle_history);
       ...
       /* ET_Amount.addTextChangedListener(new TextWatcher() {
        ...
        BtnHistory.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(WithdrawActivity.this,WithdrawalHistActivity.class);
    ...
    public void mobileNumberList(final String memberId) {
        ...
        String url = Constant.URL+"getMobileNos?membercode="+memberId;
            ...
            public void onResponse(JSONArray response)
            {
                try
                {
                    ...
                    for (int i = 0; i < response.length(); i++)
                    {
                        ...
                        String request_mobile_no = jsonObject2.getString("bank_mobile_no");
    ...
    public void account_no_list(final String memberId,final String mobile_no) {
        RequestQueue MyRequestQueue = Volley.newRequestQueue(getApplicationContext());
        String url = Constant.URL+"getBankAccByMobile?membercode="+memberId+"&mobile="+mobile_no;
        JsonArrayRequest MyStringRequest = new JsonArrayRequest(Request.Method.POST, url, new Response.Listener<JSONArray>()
        {
            @Override
            public void onResponse(JSONArray response)
    ...
    public void putWithdraw(final String memberId, final String mobile_no, final String bank_id, final String amount)
    {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError
            {
                ...
                params.put("request_mobile_no",mobile_no);
