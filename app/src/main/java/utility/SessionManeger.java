...
public class SessionManeger
{
    ...
    public  void createSession(String userId, String name, String email, String phone, String member_id,String city)
    {
...
//            context.startActivity(intent);
    ...
    public HashMap<String,String> getUserDetails()
    {
        ...
        hashMap.put(CITY,preferences.getString(CITY,null));
        return hashMap;
    }
